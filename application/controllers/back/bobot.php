...
class Bobot extends CI_Controller {
	...
	public function index($offset=0){
		...
		$config['base_url'] = base_url().'/back/bobot/index';
      	...
      	$config['full_tag_close'] ="</ul>";
   		...
   		$this->uri->segment(0) ? $this->uri->segment(0) : 0;
	...
	public function edit_aksi() {
    	$data_bobot = array(
          ...
          $this->session->set_flashdata("pesan", "<div class=\"alert alert-info\" id=\"alert\"><i class=\"glyphicon glyphicon-danger\"></i> Data berhasil diupdate</div>"); 
          redirect('back/bobot');
    }
	...
	public function delete($id) {
		...
		$this->session->set_flashdata("pesan", "<div class=\"alert alert-danger\" id=\"alert\"><i class=\"glyphicon glyphicon-danger\"></i> Data berhasil dihapus</div>"); 
		redirect('back/bobot');
	}
}

...
class M_pemeriksaan extends CI_Model{
  ...
  {
   $this->db->select('*');
     $this->db->from('tb_diagnosa','tb_user','tb_penyakit','tb_bayes','tb_sapi');
     ...
     $this->db->join('tb_sapi', 'tb_diagnosa.id_sapi = tb_sapi.id_sapi','Left');
  ...
  {
   $this->db->select('tb_diagnosa.id_diagnosa,tb_user.username,tb_diagnosa.id_penyakit,tb_sapi.nama_sapi,tb_user.nama,tb_penyakit.nama_penyakit,tb_penyakit.definisi,tb_diagnosa.tgl_diagnosa,tb_diagnosa.hasil,tb_bayes.teorema_bayes');
     $this->db->from('tb_diagnosa','tb_user','tb_penyakit','tb_bayes','tb_sapi');
     $this->db->join('tb_user', 'tb_diagnosa.id_user = tb_user.id_user','Left');
     $this->db->join('tb_penyakit', 'tb_diagnosa.id_penyakit = tb_penyakit.id_penyakit','Left');
     $this->db->join('tb_bayes', 'tb_diagnosa.id_bayes = tb_bayes.id_bayes','Left');
 ...
 public function hasil_user($id)
  ...
  public function get_cari($data_cari) {
     $this->db->select('tb_diagnosa.id_diagnosa,tb_diagnosa.id_penyakit,tb_sapi.nama_sapi,tb_user.username,tb_penyakit.nama_penyakit,tb_penyakit.definisi,tb_diagnosa.tgl_diagnosa,tb_diagnosa.hasil,tb_bayes.teorema_bayes');
     $this->db->from('tb_diagnosa','tb_user','tb_penyakit','tb_bayes','tb_sapi');
     $this->db->join('tb_user', 'tb_diagnosa.id_user = tb_user.id_user','Left');
     $this->db->join('tb_penyakit', 'tb_diagnosa.id_penyakit = tb_penyakit.id_penyakit','Left');
     $this->db->join('tb_bayes', 'tb_diagnosa.id_bayes = tb_bayes.id_bayes','Left');
     ...
     $this->db->or_like('nama_sapi', $data_cari);
   ...
   public function get_cari_user($data_cari,$id) {
     ...
     $this->db->join('tb_bayes', 'tb_diagnosa.id_bayes = tb_bayes.id_bayes','Left');
     $this->db->join('tb_sapi', 'tb_diagnosa.id_sapi = tb_sapi.id_sapi','Left');
     $this->db->like('nama_sapi', $data_cari);
     $this->db->or_like('nama_penyakit', $data_cari);
     $this->db->where('tb_diagnosa.id_user',$id);
     $query = $this->db->get();
     return $query->result_array();

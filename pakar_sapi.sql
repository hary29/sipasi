...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2018 at 03:54 PM
...
INSERT INTO `tb_diagnosa` (`id_diagnosa`, `id_user`, `id_sapi`, `id_penyakit`, `tgl_diagnosa`, `hasil`, `id_bayes`, `usia`) VALUES
...
--
-- Table structure for table `tb_sapi`
--

CREATE TABLE `tb_sapi` (
  `id_sapi` int(10) NOT NULL,
  `kode_sapi` varchar(255) NOT NULL,
...
--
-- Dumping data for table `tb_sapi`
--

INSERT INTO `tb_sapi` (`id_sapi`, `kode_sapi`, `nama_sapi`, `tanggal_lahir`, `id_user`) VALUES
(1, 'A-1001', 'qwerttrrrr', '0000-00-00', 4),
(2, 'A-1002', 'fghjkl;', '0000-00-00', 3),
(3, 'A-1003', 'ras', '2017-08-08', 2),
(4, 'A-1004', 'ssaa', '2018-03-01', 2),
(5, 'A-1005', 'asdf', '2018-02-27', 2);
...
--
-- AUTO_INCREMENT for table `tb_sapi`
--
ALTER TABLE `tb_sapi`
  MODIFY `id_sapi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
